...
@Component({
  ...
  template: `
    <div class="map-container" #mapContainer
      ...
      <svg [attr.viewBox]="'0 0 400 400'"
        ...
        <!-- Stadium Outer Shell (oval) -->
        <ellipse cx="200" cy="200" rx="185" ry="185"
                 fill="none"
                 stroke="rgba(255,255,255,0.08)"
                 stroke-width="2"/>

        <!-- Outer concourse ring -->
        <ellipse cx="200" cy="200" rx="175" ry="175"
        ...
        <!-- Playing Field -->
        <rect x="140" y="155" width="120" height="90" rx="8"
        ...
        <!-- Zone labels (separate layer so they render on top) -->
        @for (zone of zones(); track zone.id) {
          <text [attr.x]="zone.position.x"
  ...
  styles: [`
    ...
    /* ─── Highlight Ring: pulses 2× then stops ─── */
    .highlight-ring {
...
export class StadiumMapComponent implements AfterViewInit {
  ...
  /** Check if a zone should be highlighted for quick action */
